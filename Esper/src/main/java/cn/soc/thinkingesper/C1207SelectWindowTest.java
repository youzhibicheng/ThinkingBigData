 ...
 */
class SelectEvent1207 implements Serializable {
	private String name;
	private int size;
...
public class C1207SelectWindowTest {
	public static void main(String[] args) {
		EPServiceProvider epService = EPServiceProviderManager.getDefaultProvider();
		EPAdministrator admin = epService.getEPAdministrator();
		EPRuntime runtime = epService.getEPRuntime();

		String selectEvent = SelectEvent1207.class.getName();
		...
		SelectEvent1207 se1 = new SelectEvent1207();
		se1.setName("se1");
		se1.setSize(1);
		runtime.sendEvent(se1);
		System.out.println("Send SelectEvent1207 1: " + se1);

		SelectEvent1207 se2 = new SelectEvent1207();
		se2.setName("se2");
		se2.setSize(2);
		runtime.sendEvent(se2);
		System.out.println("Send SelectEvent1207 2: " + se2);
		...
		System.out.println("\nUpdate SelectEvent1207(size = 2) in SelectWindow!");
		...
		// 删除size<2的事件
		System.out.println("\nDelete SelectEvent1207(size < 2) in SelectWindow!");
